...
// [FromServices] attribute is used to explicitly specify that the DbContext should be injected from the DI container.
// This resolves an issue where Minimal APIs can sometimes incorrectly infer that the DbContext is coming from the request body.
